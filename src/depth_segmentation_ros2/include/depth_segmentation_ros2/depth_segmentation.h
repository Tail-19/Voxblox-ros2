...
// #include "../cfg/DepthSegmenter.cfg" 
...
class DepthSegmenter {
 public:
  DepthSegmenter(const DepthCamera& depth_camera, Params& params)
    ...
    // params_.normals.window_size = 13;
    std::cout << "params_.normals.window_size: " << params_.normals.window_size << std::endl;
    std::cout << "params.label: " << params_.label.min_size << std::endl;
    std::cout << "params.dilation: " << params.dilation_size << std::endl;
