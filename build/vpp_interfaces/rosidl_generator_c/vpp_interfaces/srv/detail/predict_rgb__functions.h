...
#ifndef VPP_INTERFACES__SRV__DETAIL__PREDICT_RGB__FUNCTIONS_H_
#define VPP_INTERFACES__SRV__DETAIL__PREDICT_RGB__FUNCTIONS_H_
...
/// Initialize srv/PredictRGB message.
/**
...
/// Finalize srv/PredictRGB message.
/**
...
/// Create srv/PredictRGB message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vpp_interfaces__srv__PredictRGB_Request__init().
...
/// Destroy srv/PredictRGB message.
/**
 * It calls
 * vpp_interfaces__srv__PredictRGB_Request__fini()
...
/// Check for srv/PredictRGB message equality.
/**
...
/// Initialize array of srv/PredictRGB messages.
/**
...
/// Finalize array of srv/PredictRGB messages.
/**
 * It calls
 * vpp_interfaces__srv__PredictRGB_Request__fini()
...
/// Create array of srv/PredictRGB messages.
/**
 * It allocates the memory for the array and calls
 * vpp_interfaces__srv__PredictRGB_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PredictRGB messages.
/**
 * It calls
 * vpp_interfaces__srv__PredictRGB_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PredictRGB message array equality.
/**
...
/// Copy an array of srv/PredictRGB messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * vpp_interfaces__srv__PredictRGB_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vpp_interfaces
...
/**
 * It calls
 * vpp_interfaces__srv__PredictRGB_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_vpp_interfaces
...
/**
 * It allocates the memory for the array and calls
 * vpp_interfaces__srv__PredictRGB_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_vpp_interfaces
...
/**
 * It calls
 * vpp_interfaces__srv__PredictRGB_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // VPP_INTERFACES__SRV__DETAIL__PREDICT_RGB__FUNCTIONS_H_
