...
#include "vpp_interfaces/msg/detail/result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vpp_interfaces::msg::Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vpp_interfaces::msg::Result *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vpp_interfaces::msg::Result *>(
    untyped_ros_message);
...
{
  return &vpp_interfaces::msg::typesupport_fastrtps_cpp::_Result__handle;
}
