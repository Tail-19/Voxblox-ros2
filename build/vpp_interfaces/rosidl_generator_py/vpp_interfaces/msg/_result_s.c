...
bool vpp_interfaces__msg__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("vpp_interfaces.msg._result.Result", full_classname_dest, 33) == 0);
  }
  vpp_interfaces__msg__Result * ros_message = _ros_message;
  {  // header
  ...
  {  // boxes
    ...
    if (!sensor_msgs__msg__region_of_interest__convert_from_py(field, &ros_message->boxes)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // class_ids
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int64_t * dest = ros_message->class_ids.data;
...
PyObject * vpp_interfaces__msg__result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("vpp_interfaces.msg._result");
  ...
  {  // boxes
    PyObject * field = NULL;
    field = sensor_msgs__msg__region_of_interest__convert_to_py(&ros_message->boxes);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // class_ids
    ...
    if (ros_message->class_ids.size > 0) {
      ...
      int64_t * src = &(ros_message->class_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->class_ids.size * sizeof(int64_t));
      assert(data != NULL);
